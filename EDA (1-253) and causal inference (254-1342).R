...
##### Though we have now assumed causal sufficiency, we still allow MIIC to search for latent confounding. This is to check our assumption and also here checks if home variables are confounded by away variables or vice-versa.
