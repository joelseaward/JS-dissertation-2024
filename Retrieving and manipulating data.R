...
laliga.04.05.05.06 <- FreeCompetitions() %>%
  filter(competition_id==11) %>%
  filter((season_id==38)|(season_id==37))
Matches <- FreeMatches(laliga.04.05.05.06)
StatsBombData <- free_allevents(MatchesDF=Matches,Parallel=T) 
laliga.validation.data = allclean(StatsBombData) 
save(laliga.validation.data, file="laligavalidationdata")

#####

ligue.1 <- FreeCompetitions() %>%
  filter(competition_id==7)
Matches <- FreeMatches(ligue.1)
StatsBombData <- free_allevents(MatchesDF=Matches,Parallel=T) 
ligue.1..test.data = allclean(StatsBombData) 
save(ligue.1..test.data, file="liguetestdata")

##### all matches

Matches=FreeMatches(FreeCompetitions())
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Atlético Madrid"]="Atl?tico Madrid"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Atlético Madrid"]="Atl?tico Madrid"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Cádiz"]="C?diz"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Cádiz"]="C?diz"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Deportivo Alavés"]="Deportivo Alav?s"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Deportivo Alavés"]="Deportivo Alav?s"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Málaga"]="M?laga"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Málaga"]="M?laga"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Leganés"]="Legan?s"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Leganés"]="Legan?s"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="RC Deportivo La Coruña"]="RC Deportivo La Coru?a"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="RC Deportivo La Coruña"]="RC Deportivo La Coru?a"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Gimn? stic Tarragona"]="Gimn?stic Tarragona"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Gimn? stic Tarragona"]="Gimn?stic Tarragona"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Sporting Gijón"]="Sporting Gij?n"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Sporting Gijón"]="Sporting Gij?n"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Almería"]="Almer?a"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Almería"]="Almer?a"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Hércules"]="H?rcules"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Hércules"]="H?rcules"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Córdoba CF"]="C?rdoba CF"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Córdoba CF"]="C?rdoba CF"
Matches$home_team.home_team_name[Matches$home_team.home_team_name=="Cádiz"]="C?diz"
Matches$away_team.away_team_name[Matches$away_team.away_team_name=="Cádiz"]="C?diz"
Matches$home_team.home_team_name[Matches$match_id==68336]="Gimn?stic Tarragona"
