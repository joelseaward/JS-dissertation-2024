...
###
par(mfrow=c(3,3))
for(i in 1:length(variables.updated)){
  qqnorm(miic.data.2.scaled[,which(variables.updated==variables.updated[i])],
         main=variables.updated[i]) }  # some variables are now gaussian
###
...
miic(mixed.data[,c("Team","PL")],latent="yes")
...
##################################
miic(laliga.validation.data.all.5.mins[,c("Home.Team","Home.xG","Home.passes.completed","Home.passes.attempted")],latent="yes")
miic(laliga.validation.data.all.5.mins[,c("Away.Team","Away.xG","Away.passes.completed","Away.passes.attempted")],latent="yes")
...
labels.HxGpS=c("0",paste0("(",formatC(breaks.HxGpS[-length(breaks.HxGpS)],format="fg",digits=3),",",
                          formatC(breaks.HxGpS[-1],format="fg",digits=3),"]"))
labels.HxGpS=labels.HxGpS[-2]
...
labels.AxGpS=c("0",paste0("(",formatC(breaks.AxGpS[-length(breaks.AxGpS)],format="fg",digits=3),",",
                          formatC(breaks.AxGpS[-1],format="fg",digits=3),"]"))
labels.AxGpS=labels.AxGpS[-2]
...
labels.Home.xG=c("0",paste0("(",formatC(breaks.Home.xG[-length(breaks.Home.xG)],format="fg",digits=3),",",
                            formatC(breaks.Home.xG[-1],format="fg",digits=3),"]"))
labels.Home.xG=labels.Home.xG[-2]
...
labels.Away.xG=c("0",paste0("(",formatC(breaks.Away.xG[-length(breaks.Away.xG)],format="fg",digits=3),",",
                            formatC(breaks.Away.xG[-1],format="fg",digits=3),"]"))
labels.Away.xG=labels.Away.xG[-2]
discretized.Away.xG=cut(discretize.xG.data$Away.xG,breaks=breaks.Away.xG,include.lowest=TRUE,labels=labels.Away.xG)
discrete.data=as.data.frame(cbind(VAR.discrete,rbind(miic.data.1[,c("HCross","ACross","HCorn","ACorn","HS","AS")],valid.discretization.data[,c("HCross","ACross","HCorn","ACorn","HS","AS")]),discretized.HxGpS,discretized.AxGpS,discretized.Home.xG,discretized.Away.xG))
...
dag.factorisation="[T][HPL][APL][HPA|T][APA|T][HPC|HPL:HPA][APC|APL:APA][HCP|HPC][ACP|APC][HPos|HPC:APC][HPP|HPC:APL][APP|APC:HPL][HPosFT|HPos:HPP:HPA][APosFT|HPos:APP:APA][HCross|HPosFT:HPos:HPA][ACross|APosFT:HPos:APA][HCorn|HPosFT:HPos:T][ACorn|APosFT:HPos:T][HS|HCorn:HPosFT:HPos][AS|ACorn:APosFT:HPos][HxGpS|HS:HCross:HPP][AxGpS|AS:ACross:APP][HxG|HS:HxGpS][AxG|AS:AxGpS]" 

dag=model2network(dag.factorisation)
dag.fit=bn.fit(dag,discrete.data.train)

length(which(predict(dag.fit,node="HxG",data=discrete.data.valid)==discrete.data.valid$HxG))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="AxG",data=discrete.data.valid)==discrete.data.valid$AxG))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HxGpS",data=discrete.data.valid)==discrete.data.valid$HxGpS))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="AxGpS",data=discrete.data.valid)==discrete.data.valid$AxGpS))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HPos",data=discrete.data.valid)==discrete.data.valid$HPos))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HS",data=discrete.data.valid)==discrete.data.valid$HS))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="AS",data=discrete.data.valid)==discrete.data.valid$AS))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HCorn",data=discrete.data.valid)==discrete.data.valid$HCorn))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="ACorn",data=discrete.data.valid)==discrete.data.valid$ACorn))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HCross",data=discrete.data.valid)==discrete.data.valid$HCross))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="ACross",data=discrete.data.valid)==discrete.data.valid$ACross))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HPP",data=discrete.data.valid)==discrete.data.valid$HPP))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="APP",data=discrete.data.valid)==discrete.data.valid$APP))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HPosFT",data=discrete.data.valid)==discrete.data.valid$HPosFT))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="APosFT",data=discrete.data.valid)==discrete.data.valid$APosFT))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HPC",data=discrete.data.valid)==discrete.data.valid$HPC))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="APC",data=discrete.data.valid)==discrete.data.valid$APC))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HPA",data=discrete.data.valid)==discrete.data.valid$HPA))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="APA",data=discrete.data.valid)==discrete.data.valid$APA))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="HCP",data=discrete.data.valid)==discrete.data.valid$HCP))/length(discrete.data.valid$HxG)
length(which(predict(dag.fit,node="ACP",data=discrete.data.valid)==discrete.data.valid$ACP))/length(discrete.data.valid$HxG)
...
plot(L.HPC.lag.2)     #clear with HPC.prev
plot(L.APC.lag.2)     #clear with ACP.prev
...
previous.period.discrete.data=discrete.data.train[-10694,]
...
dag.dynamic=model2network(paste0("[T.prev][HPL.prev][APL.prev][HPA.prev|T.prev][APA.prev|T.prev][HPC.prev|HPL.prev:HPA.prev][APC.prev|APL.prev:APA.prev][HCP.prev|HPC.prev][ACP.prev|APC.prev][HPos.prev|HPC.prev:APC.prev][HPP.prev|HPC.prev:APL.prev][APP.prev|APC.prev:HPL.prev][HPosFT.prev|HPos.prev:HPP.prev:HPA.prev][APosFT.prev|HPos.prev:APP.prev:APA.prev][HCross.prev|HPosFT.prev:HPos.prev:HPA.prev][ACross.prev|APosFT.prev:HPos.prev:APA.prev][HCorn.prev|HPosFT.prev:HPos.prev:T.prev][ACorn.prev|APosFT.prev:HPos.prev:T.prev][HS.prev|HCorn.prev:HPosFT.prev:HPos.prev][AS.prev|ACorn.prev:APosFT.prev:HPos.prev][HxGpS.prev|HS.prev:HCross.prev:HPP.prev][AxGpS.prev|AS.prev:ACross.prev:APP.prev][HxG.prev|HS.prev:HxGpS.prev][AxG.prev|AS.prev:AxGpS.prev][T|T.prev][HPL|HPL.prev][APL|APL.prev][HPA|T][APA|T][HPC|HPL:HPA:HPC.prev][APC|APL:APA:APC.prev][HCP|HPC:HCP.prev][ACP|APC:ACP.prev][HPos|HPC:APC][HPP|HPC:APL:HPP.prev][APP|APC:HPL:APP.prev][HPosFT|HPos:HPP:HPA:HPosFT.prev][APosFT|HPos:APP:APA:APosFT.prev][HCross|HPosFT:HPos:HPA][ACross|APosFT:HPos:APA][HCorn|HPosFT:HPos:T][ACorn|APosFT:HPos:T][HS|HCorn:HPosFT:HPos][AS|ACorn:APosFT:HPos][HxGpS|HS:HCross:HPP][AxGpS|AS:ACross:APP][HxG|HS:HxGpS][AxG|AS:AxGpS]"))
...
previous.period.discrete.data.valid=discrete.data.valid[-4310,]
...
length(which(predict(dag.fit.dynamic,node="HxG",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HxG))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="AxG",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$AxG))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HxGpS",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HxGpS))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="AxGpS",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$AxGpS))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HPos",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HPos))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HS",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HS))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="AS",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$AS))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HCorn",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HCorn))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="ACorn",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$ACorn))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HCross",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HCross))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="ACross",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$ACross))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HPP",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HPP))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="APP",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$APP))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HPosFT",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HPosFT))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="APosFT",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$APosFT))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HPC",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HPC))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="APC",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$APC))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HPA",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HPA))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="APA",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$APA))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="HCP",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$HCP))/length(discrete.data.with.lag.valid$HxG)
length(which(predict(dag.fit.dynamic,node="ACP",data=discrete.data.with.lag.valid[,-c(1,2)])==discrete.data.with.lag.valid$ACP))/length(discrete.data.with.lag.valid$HxG)
